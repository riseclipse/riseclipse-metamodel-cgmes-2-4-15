 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.CutActionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.CutActionImpl#getSwitchingStepGroup <em>Switching Step Group</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.CutActionImpl#getCut <em>Cut</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CutActionImpl extends SwitchingStepImpl implements CutAction {
    ...
    public void setKind( TempEquipActionKind newKind ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.CUT_ACTION__KIND, oldKind, kind,
                    !oldKindESet ) );
    }
    ...
    public void unsetKind() {
        ...
        kindESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.CUT_ACTION__KIND, oldKind,
    ...
    public void setCut( Cut newCut ) {
        if( newCut != cut ) {
            ...
            cutESet = true;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.CUT_ACTION__CUT, newCut, newCut,
                        !oldCutESet ) );
        }
    }
    ...
    public void unsetCut() {
        if( cut != null ) {
            ...
            cutESet = false;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.CUT_ACTION__CUT, null, null,
                        oldCutESet ) );
        }
    }
    ...
    public void unsetSwitchingStepGroup() {
        if( switchingStepGroup != null ) {
            ...
            switchingStepGroupESet = false;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.CUT_ACTION__SWITCHING_STEP_GROUP,
