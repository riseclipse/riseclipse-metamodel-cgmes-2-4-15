 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SynchronousMachineDynamicsImpl#getMechanicalLoadDynamics <em>Mechanical Load Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SynchronousMachineDynamicsImpl#getExcitationSystemDynamics <em>Excitation System Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SynchronousMachineDynamicsImpl#getGenICompensationForGenJ <em>Gen ICompensation For Gen J</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SynchronousMachineDynamicsImpl#getSynchronousMachine <em>Synchronous Machine</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SynchronousMachineDynamicsImpl#getTurbineGovernorDynamics <em>Turbine Governor Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SynchronousMachineDynamicsImpl extends RotatingMachineDynamicsImpl implements SynchronousMachineDynamics {
    ...
    public EList< TurbineGovernorDynamics > getTurbineGovernorDynamics() {
        if( turbineGovernorDynamics == null ) {
            turbineGovernorDynamics = new EObjectWithInverseEList.Unsettable.ManyInverse< TurbineGovernorDynamics >(
