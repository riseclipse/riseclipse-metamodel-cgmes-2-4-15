 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OperationTagImpl#getAsset <em>Asset</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OperationTagImpl#getTagAction <em>Tag Action</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OperationTagImpl#getPowerSystemResource <em>Power System Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationTagImpl extends DocumentImpl implements OperationTag {
    ...
    public NotificationChain basicSetAsset( Asset newAsset, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.OPERATION_TAG__ASSET, oldAsset, newAsset, !oldAssetESet );
            if( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicUnsetAsset( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.OPERATION_TAG__ASSET, oldAsset, null, oldAssetESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetAsset() {
        if( asset != null ) {
            NotificationChain msgs = null;
            msgs = ( ( InternalEObject ) asset ).eInverseRemove( this, CimPackage.ASSET__OPERATION_TAGS, Asset.class,
                    msgs );
    ...
    public NotificationChain basicSetPowerSystemResource( PowerSystemResource newPowerSystemResource,
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.OPERATION_TAG__POWER_SYSTEM_RESOURCE, oldPowerSystemResource, newPowerSystemResource,
    ...
    public void setPowerSystemResource( PowerSystemResource newPowerSystemResource ) {
        if( newPowerSystemResource != powerSystemResource ) {
            ...
            powerSystemResourceESet = true;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.OPERATION_TAG__POWER_SYSTEM_RESOURCE,
    ...
    public NotificationChain basicUnsetPowerSystemResource( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.OPERATION_TAG__POWER_SYSTEM_RESOURCE, oldPowerSystemResource, null,
                    oldPowerSystemResourceESet );
            if( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicSetTagAction( TagAction newTagAction, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.OPERATION_TAG__TAG_ACTION, oldTagAction, newTagAction, !oldTagActionESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public NotificationChain basicUnsetTagAction( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.OPERATION_TAG__TAG_ACTION, oldTagAction, null, oldTagActionESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
