 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.MeasurementValueImpl#getSensorAccuracy <em>Sensor Accuracy</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.MeasurementValueImpl#getTimeStamp <em>Time Stamp</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.MeasurementValueImpl#getMeasurementValueSource <em>Measurement Value Source</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.MeasurementValueImpl#getRemoteSource <em>Remote Source</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.MeasurementValueImpl#getProcedureDataSets <em>Procedure Data Sets</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.MeasurementValueImpl#getMeasurementValueQuality <em>Measurement Value Quality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementValueImpl extends IdentifiedObjectImpl implements MeasurementValue {
    ...
    public EList< ProcedureDataSet > getProcedureDataSets() {
        if( procedureDataSets == null ) {
            procedureDataSets = new EObjectWithInverseEList.Unsettable.ManyInverse< ProcedureDataSet >(
                    ProcedureDataSet.class, this, CimPackage.MEASUREMENT_VALUE__PROCEDURE_DATA_SETS,
                    CimPackage.PROCEDURE_DATA_SET__MEASUREMENT_VALUES );
        }
