 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getDrProgramLevel <em>Dr Program Level</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getDrProgramMandatory <em>Dr Program Mandatory</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getIssuerID <em>Issuer ID</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getIssuerTrackingID <em>Issuer Tracking ID</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getPriceSignal <em>Price Signal</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getPrimaryDeviceTiming <em>Primary Device Timing</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getScheduledInterval <em>Scheduled Interval</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getSecondaryDeviceTiming <em>Secondary Device Timing</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getEndDeviceAction <em>End Device Action</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getEndDeviceGroups <em>End Device Groups</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getUsagePointGroups <em>Usage Point Groups</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getEndDeviceControlType <em>End Device Control Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getEndDevices <em>End Devices</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.EndDeviceControlImpl#getUsagePoints <em>Usage Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndDeviceControlImpl extends IdentifiedObjectImpl implements EndDeviceControl {
    ...
    public EList< UsagePoint > getUsagePoints() {
        if( usagePoints == null ) {
            usagePoints = new EObjectWithInverseEList.Unsettable.ManyInverse< UsagePoint >( UsagePoint.class, this,
                    CimPackage.END_DEVICE_CONTROL__USAGE_POINTS, CimPackage.USAGE_POINT__END_DEVICE_CONTROLS );
        }
        return usagePoints;
    }
