 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ServiceCategoryImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ServiceCategoryImpl#getCustomerAgreements <em>Customer Agreements</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ServiceCategoryImpl#getPricingStructures <em>Pricing Structures</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ServiceCategoryImpl#getConfigurationEvents <em>Configuration Events</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ServiceCategoryImpl#getUsagePoints <em>Usage Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceCategoryImpl extends IdentifiedObjectImpl implements ServiceCategory {
    ...
    public void setKind( ServiceKind newKind ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.SERVICE_CATEGORY__KIND, oldKind, kind,
                    !oldKindESet ) );
    }
    ...
    public void unsetKind() {
        ...
        kindESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.SERVICE_CATEGORY__KIND, oldKind,
