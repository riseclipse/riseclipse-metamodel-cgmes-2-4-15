 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getArmedTimeout <em>Armed Timeout</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getCustomerVoltageLimit <em>Customer Voltage Limit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getEnergyLimit <em>Energy Limit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getEnergyUsageStartDateTime <em>Energy Usage Start Date Time</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getEnergyUsageWarning <em>Energy Usage Warning</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getIsArmConnect <em>Is Arm Connect</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getIsArmDisconnect <em>Is Arm Disconnect</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getIsEnergyLimiting <em>Is Energy Limiting</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getNeedsPowerLimitCheck <em>Needs Power Limit Check</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getNeedsVoltageLimitCheck <em>Needs Voltage Limit Check</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getPowerLimit <em>Power Limit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.RemoteConnectDisconnectInfoImpl#getUsePushbutton <em>Use Pushbutton</em>}</li>
 * </ul>
 *
 * @generated
 */
