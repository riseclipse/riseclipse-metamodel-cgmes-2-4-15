 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PrimeMoverImpl#getPrimeMoverRating <em>Prime Mover Rating</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PrimeMoverImpl#getSynchronousMachines <em>Synchronous Machines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimeMoverImpl extends PowerSystemResourceImpl implements PrimeMover {
    ...
    public EList< SynchronousMachine > getSynchronousMachines() {
        if( synchronousMachines == null ) {
            synchronousMachines = new EObjectWithInverseEList.Unsettable.ManyInverse< SynchronousMachine >(
