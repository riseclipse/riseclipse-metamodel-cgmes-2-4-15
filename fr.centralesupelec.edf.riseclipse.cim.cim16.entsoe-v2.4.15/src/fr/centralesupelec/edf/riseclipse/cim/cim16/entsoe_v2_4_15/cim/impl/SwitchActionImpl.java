 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SwitchActionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SwitchActionImpl#getPlannedOutage <em>Planned Outage</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SwitchActionImpl#getSwitchingStepGroup <em>Switching Step Group</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SwitchActionImpl#getOperatedSwitch <em>Operated Switch</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchActionImpl extends SwitchingStepImpl implements SwitchAction {
    ...
    public Switch getOperatedSwitch() {
        if( operatedSwitch != null && operatedSwitch.eIsProxy() ) {
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.SWITCH_ACTION__OPERATED_SWITCH:
            if( resolve ) return getOperatedSwitch();
            return basicGetOperatedSwitch();
        }
