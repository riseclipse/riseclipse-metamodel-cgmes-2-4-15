 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsElectricVehicle <em>Is Electric Vehicle</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsExteriorLighting <em>Is Exterior Lighting</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsGenerationSystem <em>Is Generation System</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsHvacCompressorOrFurnace <em>Is Hvac Compressor Or Furnace</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsInteriorLighting <em>Is Interior Lighting</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsIrrigationPump <em>Is Irrigation Pump</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsManagedCommercialIndustrialLoad <em>Is Managed Commercial Industrial Load</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsPoolPumpSpaJacuzzi <em>Is Pool Pump Spa Jacuzzi</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsSimpleMiscLoad <em>Is Simple Misc Load</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsSmartAppliance <em>Is Smart Appliance</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsStripAndBaseboardHeater <em>Is Strip And Baseboard Heater</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ControlledApplianceImpl#getIsWaterHeater <em>Is Water Heater</em>}</li>
 * </ul>
 *
 * @generated
 */
