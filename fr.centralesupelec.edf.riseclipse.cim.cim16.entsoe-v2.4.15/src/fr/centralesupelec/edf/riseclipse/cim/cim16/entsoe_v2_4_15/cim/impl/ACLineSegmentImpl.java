 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getB0ch <em>B0ch</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getBch <em>Bch</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getG0ch <em>G0ch</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getGch <em>Gch</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getR <em>R</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getR0 <em>R0</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getShortCircuitEndTemperature <em>Short Circuit End Temperature</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getX <em>X</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getLineJumpingAction <em>Line Jumping Action</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getPerLengthImpedance <em>Per Length Impedance</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getLineGroundingAction <em>Line Grounding Action</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getClamp <em>Clamp</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getCut <em>Cut</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getACLineSegmentPhases <em>AC Line Segment Phases</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ACLineSegmentImpl#getLineFaults <em>Line Faults</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ACLineSegmentImpl extends ConductorImpl implements ACLineSegment {
    ...
    /**
     * The cached value of the '{@link #getACLineSegmentPhases() <em>AC Line Segment Phases</em>}' reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    public EList< ACLineSegmentPhase > getACLineSegmentPhases() {
        if( acLineSegmentPhases == null ) {
            acLineSegmentPhases = new EObjectWithInverseResolvingEList.Unsettable< ACLineSegmentPhase >(
                    ACLineSegmentPhase.class, this, CimPackage.AC_LINE_SEGMENT__AC_LINE_SEGMENT_PHASES,
                    CimPackage.AC_LINE_SEGMENT_PHASE__AC_LINE_SEGMENT );
        }
        return acLineSegmentPhases;
    }
    ...
    public void unsetACLineSegmentPhases() {
        if( acLineSegmentPhases != null ) ( ( InternalEList.Unsettable< ? > ) acLineSegmentPhases ).unset();
    }
    ...
    public boolean isSetACLineSegmentPhases() {
        return acLineSegmentPhases != null && ( ( InternalEList.Unsettable< ? > ) acLineSegmentPhases ).isSet();
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        ...
        case CimPackage.AC_LINE_SEGMENT__AC_LINE_SEGMENT_PHASES:
            return ( ( InternalEList< InternalEObject > ) ( InternalEList< ? > ) getACLineSegmentPhases() )
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        ...
        case CimPackage.AC_LINE_SEGMENT__AC_LINE_SEGMENT_PHASES:
            return ( ( InternalEList< ? > ) getACLineSegmentPhases() ).basicRemove( otherEnd, msgs );
        case CimPackage.AC_LINE_SEGMENT__LINE_FAULTS:
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case CimPackage.AC_LINE_SEGMENT__AC_LINE_SEGMENT_PHASES:
            ...
            getACLineSegmentPhases().addAll( ( Collection< ? extends ACLineSegmentPhase > ) newValue );
            return;
        case CimPackage.AC_LINE_SEGMENT__LINE_FAULTS:
            getLineFaults().clear();
