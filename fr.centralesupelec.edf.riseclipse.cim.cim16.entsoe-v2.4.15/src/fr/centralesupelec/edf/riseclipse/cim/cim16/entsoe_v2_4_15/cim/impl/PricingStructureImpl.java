 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getDailyCeilingUsage <em>Daily Ceiling Usage</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getDailyEstimatedUsage <em>Daily Estimated Usage</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getDailyFloorUsage <em>Daily Floor Usage</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getRevenueKind <em>Revenue Kind</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getTaxExemption <em>Tax Exemption</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getServiceCategory <em>Service Category</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getTransactions <em>Transactions</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getTariffs <em>Tariffs</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getUsagePoints <em>Usage Points</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.PricingStructureImpl#getCustomerAgreements <em>Customer Agreements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PricingStructureImpl extends DocumentImpl implements PricingStructure {
    ...
    public EList< Tariff > getTariffs() {
        if( tariffs == null ) {
            tariffs = new EObjectWithInverseEList.Unsettable.ManyInverse< Tariff >( Tariff.class, this,
