 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.FaultCauseTypeImpl#getFaults <em>Faults</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FaultCauseTypeImpl extends IdentifiedObjectImpl implements FaultCauseType {
    ...
    public EList< Fault > getFaults() {
        if( faults == null ) {
            faults = new EObjectWithInverseEList.Unsettable.ManyInverse< Fault >( Fault.class, this,
