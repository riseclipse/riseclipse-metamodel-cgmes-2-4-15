 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getR <em>R</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getR0 <em>R0</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getX <em>X</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getFromTransformerEndInfo <em>From Transformer End Info</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getFromTransformerEnd <em>From Transformer End</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getToTransformerEndInfos <em>To Transformer End Infos</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerMeshImpedanceImpl#getToTransformerEnd <em>To Transformer End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformerMeshImpedanceImpl extends IdentifiedObjectImpl implements TransformerMeshImpedance {
    ...
    public EList< TransformerEndInfo > getToTransformerEndInfos() {
        if( toTransformerEndInfos == null ) {
            toTransformerEndInfos = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< TransformerEndInfo >(
    ...
    public EList< TransformerEnd > getToTransformerEnd() {
        if( toTransformerEnd == null ) {
            toTransformerEnd = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< TransformerEnd >(
