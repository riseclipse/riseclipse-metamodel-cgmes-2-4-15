 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.CutImpl#getLengthFromTerminal1 <em>Length From Terminal1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.CutImpl#getACLineSegment <em>AC Line Segment</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.CutImpl#getCutAction <em>Cut Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CutImpl extends SwitchImpl implements Cut {
    ...
    public CutAction getCutAction() {
        if( cutAction != null && cutAction.eIsProxy() ) {
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.CUT__CUT_ACTION:
            if( resolve ) return getCutAction();
            return basicGetCutAction();
        }
