 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.JumperImpl#getJumperAction <em>Jumper Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JumperImpl extends SwitchImpl implements Jumper {
    ...
    public JumperAction getJumperAction() {
        if( jumperAction != null && jumperAction.eIsProxy() ) {
     ...
     * @generated
     */
    public JumperAction basicGetJumperAction() {
        return jumperAction;
    }
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        switch( featureID ) {
        case CimPackage.JUMPER__JUMPER_ACTION:
            if( resolve ) return getJumperAction();
            return basicGetJumperAction();
        }
