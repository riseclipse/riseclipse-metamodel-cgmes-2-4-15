 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.VisibilityLayerImpl#getDrawingOrder <em>Drawing Order</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.VisibilityLayerImpl#getVisibleObjects <em>Visible Objects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VisibilityLayerImpl extends IdentifiedObjectImpl implements VisibilityLayer {
    ...
    public EList< DiagramObject > getVisibleObjects() {
        if( visibleObjects == null ) {
            visibleObjects = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< DiagramObject >(
                    DiagramObject.class, this, CimPackage.VISIBILITY_LAYER__VISIBLE_OBJECTS,
                    CimPackage.DIAGRAM_OBJECT__VISIBILITY_LAYERS );
        }
