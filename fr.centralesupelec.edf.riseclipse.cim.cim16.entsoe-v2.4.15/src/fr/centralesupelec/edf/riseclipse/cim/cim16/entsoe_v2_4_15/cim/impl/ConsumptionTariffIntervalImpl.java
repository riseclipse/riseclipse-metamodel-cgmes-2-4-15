 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ConsumptionTariffIntervalImpl#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ConsumptionTariffIntervalImpl#getStartValue <em>Start Value</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ConsumptionTariffIntervalImpl#getCharges <em>Charges</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ConsumptionTariffIntervalImpl#getTouTariffIntervals <em>Tou Tariff Intervals</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ConsumptionTariffIntervalImpl#getTariffProfiles <em>Tariff Profiles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConsumptionTariffIntervalImpl extends CimObjectWithIDImpl implements ConsumptionTariffInterval {
    ...
    public EList< TariffProfile > getTariffProfiles() {
        if( tariffProfiles == null ) {
            tariffProfiles = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< TariffProfile >(
                    TariffProfile.class, this, CimPackage.CONSUMPTION_TARIFF_INTERVAL__TARIFF_PROFILES,
    ...
    public EList< TimeTariffInterval > getTouTariffIntervals() {
        if( touTariffIntervals == null ) {
            touTariffIntervals = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< TimeTariffInterval >(
