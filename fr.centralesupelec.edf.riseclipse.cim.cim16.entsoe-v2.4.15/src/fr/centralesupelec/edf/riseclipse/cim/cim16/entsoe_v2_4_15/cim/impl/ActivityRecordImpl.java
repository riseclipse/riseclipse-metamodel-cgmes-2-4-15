 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getCreatedDateTime <em>Created Date Time</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ActivityRecordImpl#getOrganisations <em>Organisations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityRecordImpl extends IdentifiedObjectImpl implements ActivityRecord {
    ...
    public EList< Organisation > getOrganisations() {
        if( organisations == null ) {
            organisations = new EObjectWithInverseEList.Unsettable.ManyInverse< Organisation >( Organisation.class,
                    this, CimPackage.ACTIVITY_RECORD__ORGANISATIONS, CimPackage.ORGANISATION__ACTIVITY_RECORDS );
        }
    ...
    public void unsetOrganisations() {
        if( organisations != null ) ( ( InternalEList.Unsettable< ? > ) organisations ).unset();
    }
    ...
    public boolean isSetOrganisations() {
        return organisations != null && ( ( InternalEList.Unsettable< ? > ) organisations ).isSet();
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        ...
        case CimPackage.ACTIVITY_RECORD__ASSETS:
            return ( ( InternalEList< InternalEObject > ) ( InternalEList< ? > ) getAssets() ).basicAdd( otherEnd,
                    msgs );
        case CimPackage.ACTIVITY_RECORD__ORGANISATIONS:
            return ( ( InternalEList< InternalEObject > ) ( InternalEList< ? > ) getOrganisations() )
