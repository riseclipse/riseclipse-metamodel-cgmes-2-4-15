 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getConnectionKind <em>Connection Kind</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getEmergencyS <em>Emergency S</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getEndNumber <em>End Number</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getInsulationU <em>Insulation U</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getPhaseAngleClock <em>Phase Angle Clock</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getR <em>R</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getRatedS <em>Rated S</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getRatedU <em>Rated U</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getShortTermS <em>Short Term S</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getTransformerTankInfo <em>Transformer Tank Info</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getCoreAdmittance <em>Core Admittance</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getOpenEndOpenCircuitTests <em>Open End Open Circuit Tests</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getEnergisedEndNoLoadTests <em>Energised End No Load Tests</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getEnergisedEndOpenCircuitTests <em>Energised End Open Circuit Tests</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getFromMeshImpedances <em>From Mesh Impedances</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getGroundedEndShortCircuitTests <em>Grounded End Short Circuit Tests</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getToMeshImpedances <em>To Mesh Impedances</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getEnergisedEndShortCircuitTests <em>Energised End Short Circuit Tests</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TransformerEndInfoImpl#getTransformerStarImpedance <em>Transformer Star Impedance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformerEndInfoImpl extends AssetInfoImpl implements TransformerEndInfo {
    ...
    public void setEmergencyS( Float newEmergencyS ) {
        ...
        emergencySESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__EMERGENCY_S,
                    oldEmergencyS, emergencyS, !oldEmergencySESet ) );
    }
    ...
    public void setEndNumber( Integer newEndNumber ) {
        ...
        endNumberESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__END_NUMBER,
    ...
    public void unsetEndNumber() {
        ...
        endNumberESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.TRANSFORMER_END_INFO__END_NUMBER,
    ...
    public void setInsulationU( Float newInsulationU ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__INSULATION_U,
                    oldInsulationU, insulationU, !oldInsulationUESet ) );
    }
    ...
    public void unsetPhaseAngleClock() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.TRANSFORMER_END_INFO__PHASE_ANGLE_CLOCK, oldPhaseAngleClock, PHASE_ANGLE_CLOCK_EDEFAULT,
    ...
    public void setR( Float newR ) {
        ...
        rESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__R, oldR, r,
                    !oldRESet ) );
    }
    ...
    public void unsetR() {
        ...
        rESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.TRANSFORMER_END_INFO__R, oldR,
                    R_EDEFAULT, oldRESet ) );
    }
    ...
    public void setRatedS( Float newRatedS ) {
        ...
        ratedSESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__RATED_S, oldRatedS,
    ...
    public void unsetRatedS() {
        ...
        ratedSESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.TRANSFORMER_END_INFO__RATED_S,
    ...
    public void setRatedU( Float newRatedU ) {
        ...
        ratedUESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__RATED_U, oldRatedU,
    ...
    public void unsetRatedU() {
        ...
        ratedUESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.TRANSFORMER_END_INFO__RATED_U,
    ...
    public void setShortTermS( Float newShortTermS ) {
        ...
        shortTermSESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.TRANSFORMER_END_INFO__SHORT_TERM_S,
                    oldShortTermS, shortTermS, !oldShortTermSESet ) );
    }
    ...
    public EList< TransformerMeshImpedance > getToMeshImpedances() {
        if( toMeshImpedances == null ) {
            toMeshImpedances = new EObjectWithInverseEList.Unsettable.ManyInverse< TransformerMeshImpedance >(
    ...
    public EList< ShortCircuitTest > getGroundedEndShortCircuitTests() {
        if( groundedEndShortCircuitTests == null ) {
            groundedEndShortCircuitTests = new EObjectWithInverseEList.Unsettable.ManyInverse< ShortCircuitTest >(
    ...
    public void unsetTransformerTankInfo() {
        if( transformerTankInfo != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.TRANSFORMER_END_INFO__TRANSFORMER_TANK_INFO, null, null,
                        oldTransformerTankInfoESet ) );
        }
    }
    ...
    public void setCoreAdmittance( TransformerCoreAdmittance newCoreAdmittance ) {
        if( newCoreAdmittance != coreAdmittance ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.TRANSFORMER_END_INFO__CORE_ADMITTANCE, newCoreAdmittance, newCoreAdmittance,
                        !oldCoreAdmittanceESet ) );
        }
    }
