 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getElectronicAddress <em>Electronic Address</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getPhone1 <em>Phone1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getPhone2 <em>Phone2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getPostalAddress <em>Postal Address</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getStreetAddress <em>Street Address</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getActivityRecords <em>Activity Records</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.OrganisationImpl#getRoles <em>Roles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrganisationImpl extends IdentifiedObjectImpl implements Organisation {
    ...
    public EList< ActivityRecord > getActivityRecords() {
        if( activityRecords == null ) {
            activityRecords = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< ActivityRecord >(
                    ActivityRecord.class, this, CimPackage.ORGANISATION__ACTIVITY_RECORDS,
                    CimPackage.ACTIVITY_RECORD__ORGANISATIONS );
        }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.ORGANISATION__ACTIVITY_RECORDS:
