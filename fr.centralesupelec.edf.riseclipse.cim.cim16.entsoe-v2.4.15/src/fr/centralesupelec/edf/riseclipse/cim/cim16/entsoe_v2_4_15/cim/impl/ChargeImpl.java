 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getVariablePortion <em>Variable Portion</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getFixedPortion <em>Fixed Portion</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getChildCharges <em>Child Charges</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getParentCharge <em>Parent Charge</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getTimeTariffIntervals <em>Time Tariff Intervals</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getConsumptionTariffIntervals <em>Consumption Tariff Intervals</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ChargeImpl#getAuxiliaryAccounts <em>Auxiliary Accounts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChargeImpl extends IdentifiedObjectImpl implements Charge {
    ...
    public EList< ConsumptionTariffInterval > getConsumptionTariffIntervals() {
        if( consumptionTariffIntervals == null ) {
            consumptionTariffIntervals = new EObjectWithInverseEList.Unsettable.ManyInverse< ConsumptionTariffInterval >(
    ...
    public EList< AuxiliaryAccount > getAuxiliaryAccounts() {
        if( auxiliaryAccounts == null ) {
            auxiliaryAccounts = new EObjectWithInverseEList.Unsettable.ManyInverse< AuxiliaryAccount >(
