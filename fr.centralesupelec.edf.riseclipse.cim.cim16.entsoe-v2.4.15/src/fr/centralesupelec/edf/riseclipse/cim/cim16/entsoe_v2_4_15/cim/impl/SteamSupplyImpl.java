 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SteamSupplyImpl#getSteamSupplyRating <em>Steam Supply Rating</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.SteamSupplyImpl#getSteamTurbines <em>Steam Turbines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SteamSupplyImpl extends PowerSystemResourceImpl implements SteamSupply {
    ...
    public EList< SteamTurbine > getSteamTurbines() {
        if( steamTurbines == null ) {
            steamTurbines = new EObjectWithInverseEList.Unsettable.ManyInverse< SteamTurbine >( SteamTurbine.class,
                    this, CimPackage.STEAM_SUPPLY__STEAM_TURBINES, CimPackage.STEAM_TURBINE__STEAM_SUPPLYS );
        }
