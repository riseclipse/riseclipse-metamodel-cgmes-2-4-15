 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getDthetamax <em>Dthetamax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getDthetamin <em>Dthetamin</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getKic <em>Kic</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getKiomega <em>Kiomega</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getKpc <em>Kpc</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getKpomega <em>Kpomega</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getKpx <em>Kpx</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getThetamax <em>Thetamax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getThetamin <em>Thetamin</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getTtheta <em>Ttheta</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindContPitchAngleIECImpl#getWindGenTurbineType3IEC <em>Wind Gen Turbine Type3 IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindContPitchAngleIECImpl extends IdentifiedObjectImpl implements WindContPitchAngleIEC {
        ...
        if( newWindGenTurbineType3IEC != windGenTurbineType3IEC ) {
            ...
            if( windGenTurbineType3IEC != null )
                msgs = ( ( InternalEObject ) windGenTurbineType3IEC ).eInverseRemove( this,
                        CimPackage.WIND_GEN_TURBINE_TYPE3_IEC__WIND_CONT_PITCH_ANGLE_IEC, WindGenTurbineType3IEC.class,
                        msgs );
    ...
    public NotificationChain basicUnsetWindGenTurbineType3IEC( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.WIND_CONT_PITCH_ANGLE_IEC__WIND_GEN_TURBINE_TYPE3_IEC, oldWindGenTurbineType3IEC, null,
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.WIND_CONT_PITCH_ANGLE_IEC__WIND_GEN_TURBINE_TYPE3_IEC:
            if( windGenTurbineType3IEC != null )
                msgs = ( ( InternalEObject ) windGenTurbineType3IEC ).eInverseRemove( this,
                        CimPackage.WIND_GEN_TURBINE_TYPE3_IEC__WIND_CONT_PITCH_ANGLE_IEC, WindGenTurbineType3IEC.class,
                        msgs );
