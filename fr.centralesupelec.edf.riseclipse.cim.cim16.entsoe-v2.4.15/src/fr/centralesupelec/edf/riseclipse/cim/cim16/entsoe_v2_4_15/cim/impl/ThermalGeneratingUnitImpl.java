 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getOMCost <em>OM Cost</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getFuelAllocationSchedules <em>Fuel Allocation Schedules</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getHeatInputCurve <em>Heat Input Curve</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getEmissionCurves <em>Emission Curves</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getCogenerationPlant <em>Cogeneration Plant</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getFossilFuels <em>Fossil Fuels</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getStartupModel <em>Startup Model</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getCAESPlant <em>CAES Plant</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getHeatRateCurve <em>Heat Rate Curve</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getEmmissionAccounts <em>Emmission Accounts</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getShutdownCurve <em>Shutdown Curve</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getCombinedCyclePlant <em>Combined Cycle Plant</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.ThermalGeneratingUnitImpl#getIncrementalHeatRateCurve <em>Incremental Heat Rate Curve</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThermalGeneratingUnitImpl extends GeneratingUnitImpl implements ThermalGeneratingUnit {
    ...
    public void setOMCost( Float newOMCost ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.THERMAL_GENERATING_UNIT__OM_COST,
                    oldOMCost, oMCost, !oldOMCostESet ) );
    }
    ...
    public void unsetOMCost() {
        ...
        oMCostESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.THERMAL_GENERATING_UNIT__OM_COST,
                    oldOMCost, OM_COST_EDEFAULT, oldOMCostESet ) );
    }
        ...
        if( newStartupModel != startupModel ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.THERMAL_GENERATING_UNIT__STARTUP_MODEL, newStartupModel, newStartupModel,
                        !oldStartupModelESet ) );
        }
    }
    ...
    public IncrementalHeatRateCurve getIncrementalHeatRateCurve() {
        if( incrementalHeatRateCurve != null && incrementalHeatRateCurve.eIsProxy() ) {
            ...
            if( incrementalHeatRateCurve != oldIncrementalHeatRateCurve ) {
                if( eNotificationRequired() )
                    eNotify( new ENotificationImpl( this, Notification.RESOLVE,
                            CimPackage.THERMAL_GENERATING_UNIT__INCREMENTAL_HEAT_RATE_CURVE,
                            oldIncrementalHeatRateCurve, incrementalHeatRateCurve ) );
            }
        }
    ...
    public void setShutdownCurve( ShutdownCurve newShutdownCurve ) {
        if( newShutdownCurve != shutdownCurve ) {
            ...
            if( newShutdownCurve != null )
                msgs = ( ( InternalEObject ) newShutdownCurve ).eInverseAdd( this,
                        CimPackage.SHUTDOWN_CURVE__THERMAL_GENERATING_UNIT, ShutdownCurve.class, msgs );
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.THERMAL_GENERATING_UNIT__SHUTDOWN_CURVE, newShutdownCurve, newShutdownCurve,
                        !oldShutdownCurveESet ) );
        }
    }
    ...
    public HeatRateCurve getHeatRateCurve() {
        if( heatRateCurve != null && heatRateCurve.eIsProxy() ) {
            ...
            if( heatRateCurve != oldHeatRateCurve ) {
                if( eNotificationRequired() )
                    eNotify( new ENotificationImpl( this, Notification.RESOLVE,
                            CimPackage.THERMAL_GENERATING_UNIT__HEAT_RATE_CURVE, oldHeatRateCurve, heatRateCurve ) );
            }
        }
    ...
    public void setHeatRateCurve( HeatRateCurve newHeatRateCurve ) {
        if( newHeatRateCurve != heatRateCurve ) {
            ...
            if( newHeatRateCurve != null )
                msgs = ( ( InternalEObject ) newHeatRateCurve ).eInverseAdd( this,
                        CimPackage.HEAT_RATE_CURVE__THERMAL_GENERATING_UNIT, HeatRateCurve.class, msgs );
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.THERMAL_GENERATING_UNIT__HEAT_RATE_CURVE, newHeatRateCurve, newHeatRateCurve,
                        !oldHeatRateCurveESet ) );
        }
    }
    ...
    public void setHeatInputCurve( HeatInputCurve newHeatInputCurve ) {
        if( newHeatInputCurve != heatInputCurve ) {
            ...
            if( newHeatInputCurve != null )
                msgs = ( ( InternalEObject ) newHeatInputCurve ).eInverseAdd( this,
                        CimPackage.HEAT_INPUT_CURVE__THERMAL_GENERATING_UNIT, HeatInputCurve.class, msgs );
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.THERMAL_GENERATING_UNIT__HEAT_INPUT_CURVE, newHeatInputCurve, newHeatInputCurve,
                        !oldHeatInputCurveESet ) );
        }
    }
