 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getCdrt <em>Cdrt</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getHgen <em>Hgen</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getHwtr <em>Hwtr</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getKdrt <em>Kdrt</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getWindGenTurbineType3IEC <em>Wind Gen Turbine Type3 IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getWindTurbineType4bIEC <em>Wind Turbine Type4b IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.WindMechIECImpl#getWindTurbineType1or2IEC <em>Wind Turbine Type1or2 IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindMechIECImpl extends IdentifiedObjectImpl implements WindMechIEC {
    ...
    public NotificationChain basicSetWindGenTurbineType3IEC( WindGenTurbineType3IEC newWindGenTurbineType3IEC,
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.WIND_MECH_IEC__WIND_GEN_TURBINE_TYPE3_IEC, oldWindGenTurbineType3IEC,
    ...
    public NotificationChain basicUnsetWindGenTurbineType3IEC( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.WIND_MECH_IEC__WIND_GEN_TURBINE_TYPE3_IEC, oldWindGenTurbineType3IEC, null,
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.WIND_MECH_IEC__WIND_GEN_TURBINE_TYPE3_IEC:
            if( windGenTurbineType3IEC != null )
                msgs = ( ( InternalEObject ) windGenTurbineType3IEC ).eInverseRemove( this,
                        CimPackage.WIND_GEN_TURBINE_TYPE3_IEC__WIND_MECH_IEC, WindGenTurbineType3IEC.class, msgs );
