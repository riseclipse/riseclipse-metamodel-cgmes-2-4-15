 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TurbineGovernorDynamicsImpl#getAsynchronousMachineDynamics <em>Asynchronous Machine Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TurbineGovernorDynamicsImpl#getSynchronousMachineDynamics <em>Synchronous Machine Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.impl.TurbineGovernorDynamicsImpl#getTurbineLoadControllerDynamics <em>Turbine Load Controller Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurbineGovernorDynamicsImpl extends DynamicsFunctionBlockImpl implements TurbineGovernorDynamics {
    ...
    public EList< SynchronousMachineDynamics > getSynchronousMachineDynamics() {
        if( synchronousMachineDynamics == null ) {
            synchronousMachineDynamics = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< SynchronousMachineDynamics >(
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.TURBINE_GOVERNOR_DYNAMICS__TURBINE_LOAD_CONTROLLER_DYNAMICS:
            return getTurbineLoadControllerDynamics();
        }
