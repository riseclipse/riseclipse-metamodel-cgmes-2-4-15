...
public class EndDeviceControlItemProvider extends IdentifiedObjectItemProvider {
    ...
    protected void addPriceSignalPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_EndDeviceControl_priceSignal_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_EndDeviceControl_priceSignal_feature",
                                "_UI_EndDeviceControl_type" ),
                        CimPackage.eINSTANCE.getEndDeviceControl_PriceSignal(),
                        true,
                        false,
                        true,
                        null,
    ...
    protected void addPrimaryDeviceTimingPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        ...
                        getString( "_UI_PropertyDescriptor_description",
                                "_UI_EndDeviceControl_primaryDeviceTiming_feature", "_UI_EndDeviceControl_type" ),
                        CimPackage.eINSTANCE.getEndDeviceControl_PrimaryDeviceTiming(),
                        true,
                        false,
                        true,
                        null,
    ...
    protected void addScheduledIntervalPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        ...
                        getString( "_UI_PropertyDescriptor_description",
                                "_UI_EndDeviceControl_scheduledInterval_feature", "_UI_EndDeviceControl_type" ),
                        CimPackage.eINSTANCE.getEndDeviceControl_ScheduledInterval(),
                        true,
                        false,
                        true,
                        null,
    ...
    protected void addSecondaryDeviceTimingPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        ...
                        getString( "_UI_PropertyDescriptor_description",
                                "_UI_EndDeviceControl_secondaryDeviceTiming_feature", "_UI_EndDeviceControl_type" ),
                        CimPackage.eINSTANCE.getEndDeviceControl_SecondaryDeviceTiming(),
                        true,
                        false,
                        true,
                        null,
