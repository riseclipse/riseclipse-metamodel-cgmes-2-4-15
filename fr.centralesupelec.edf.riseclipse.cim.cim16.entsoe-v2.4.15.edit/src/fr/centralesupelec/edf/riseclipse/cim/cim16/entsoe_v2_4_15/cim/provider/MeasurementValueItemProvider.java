...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cim16.entsoe_v2_4_15.cim.MeasurementValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementValueItemProvider extends IdentifiedObjectItemProvider {
    /**
    ...
    protected void addProcedureDataSetsPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(), getResourceLocator(),
                getString( "_UI_MeasurementValue_ProcedureDataSets_feature" ),
                getString( "_UI_PropertyDescriptor_description", "_UI_MeasurementValue_ProcedureDataSets_feature",
                        "_UI_MeasurementValue_type" ),
                CimPackage.eINSTANCE.getMeasurementValue_ProcedureDataSets(), true, false, true, null, null, null ) );
    }
